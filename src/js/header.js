...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Verifica se la pagina è la homepage
  if (body.classList.contains('home')) {
    const toggleHeaderStyle = () => {
      if (window.scrollY > 0) {
        body.classList.remove('home'); // Rimuove la classe 'home' dal body quando si scrolla
        ...
        body.classList.add('home'); // Aggiunge la classe 'home' al body quando si è in cima alla pagina
